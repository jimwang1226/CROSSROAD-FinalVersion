...
public class HelpQuestionTenFragment extends Fragment implements View.OnClickListener{
    private View helpQuestionTenFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        helpQuestionTenFragment = LayoutInflater.from(getActivity()).inflate(R.layout.help_question_ten_fragment,
                container, false);
        //Initialize
        soundID = SoundUtil.initSound(this.getActivity());
        setView();

        return helpQuestionTenFragment;
    }

    public void setView () {
        //initialize the view
        yesButton = (Button)helpQuestionTenFragment.findViewById(R.id.help_q10_yes_button);
        noButton = (Button)helpQuestionTenFragment.findViewById(R.id.help_q10_no_button);
        backToParentsButton = (Button)helpQuestionTenFragment.findViewById(R.id.help_return_to_for_parents_screen_button);
    ...
    //save question four
    public void saveQuesTen(String yesOrNo) {
        SharedPreferences.Editor spEditor = sharedPref.edit();
        spEditor.putString("questionTen", yesOrNo);
        spEditor.apply();
    }
