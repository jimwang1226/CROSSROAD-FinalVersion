...
public class HelpQuestionNineFragment extends Fragment implements View.OnClickListener{
    private View helpQuestionNineFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        helpQuestionNineFragment = LayoutInflater.from(getActivity()).inflate(R.layout.help_question_nine_fragment,
                container, false);
        //Initialize
        soundID = SoundUtil.initSound(this.getActivity());
        setView();

        return helpQuestionNineFragment;
    }

    public void setView () {
        //initialize the view
        yesButton = (Button)helpQuestionNineFragment.findViewById(R.id.help_q9_yes_button);
        noButton = (Button)helpQuestionNineFragment.findViewById(R.id.help_q9_no_button);
        backToParentsButton = (Button)helpQuestionNineFragment.findViewById(R.id.help_return_to_for_parents_screen_button);
    ...
    //save question four
    public void saveQuesNine(String yesOrNo) {
        SharedPreferences.Editor spEditor = sharedPref.edit();
        spEditor.putString("questionNine", yesOrNo);
        spEditor.apply();
    }
