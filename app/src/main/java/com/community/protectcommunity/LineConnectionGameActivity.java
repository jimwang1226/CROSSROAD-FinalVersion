...
public class LineConnectionGameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPump.init(ViewPump.builder()
                .addInterceptor(new CalligraphyInterceptor(
                        new CalligraphyConfig.Builder()
                                ...
                                .build()))
                .build());
        setContentView(R.layout.activity_line_conn_game);
        //Set up full screen
        ...
        //Switch fragment to connection tutorial fragment
        //or if click the continue button, switch to corresponding fragment
        Fragment nextFragment = new LineConnectionGameTutFragment();
        FragmentManager fragmentManager = getFragmentManager();
        ((LineConnectionGameTutFragment) nextFragment).setmServ(mServ);
